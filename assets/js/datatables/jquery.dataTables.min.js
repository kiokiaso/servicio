...
"",yc="";if(Intl){var zc=(new Intl.NumberFormat).formatToParts(1000.1);xc=zc[1].value;yc=zc[2].value}u.datetime=function(a,b){var c="datetime-detect-"+a;b||(b="en");u.ext.type.order[c]||(u.ext.type.detect.unshift(function(d){var e=Wa(d,a,b);return""===d||e?c:!1}),u.ext.type.order[c+"-pre"]=function(d){return Wa(d,a,b)||0})};u.render={date:ub("toLocaleDateString"),datetime:ub("toLocaleString"),time:ub("toLocaleTimeString"),number:function(a,b,c,d,e){if(null===a||a===q)a=xc;if(null===b||b===q)b=yc;
