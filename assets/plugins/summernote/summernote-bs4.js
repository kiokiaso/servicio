...
var dialog = renderer.create('<div class="modal note-modal" id="pictureTextArea" data-backdrop="static" data-keyboard="false" aria-hidden="false" tabindex="-2" role="dialog"></div>', function ($node, options) {
  if (options.fade) {
    $node.addClass('fade');
  }
