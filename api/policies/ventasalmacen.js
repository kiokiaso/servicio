    ...
    //try{
        try{
            if(req.session.passport.user){
                ...
                if(usuario.role=="Vendedor"||usuario.role=="Almacen"||usuario.role=="Gerente"||usuario.role=="Gerente General"||usuario.role=="Direccion"||usuario.role=="Gerente Ventas"||usuario.role=="SuperAdministrador"||usuario.role=="Administrador"){
                    return next();
                }
                else{
